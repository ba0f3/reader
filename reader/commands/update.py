...
from reader.repositories import EntryRepository, FeedRepository, UserEntryRepository
...
def metadata(feed_id=None):
    ...
    for feed in feeds:
        ...
        if 'ttl' in d.channel:
            ...
            update_period = d.channel.sy_updateperiod if 'sy_updateperiod' in d.channel else reader.settings.FEED_UPDATE_PERIOD
            ...
            update_frequency = int(d.channel.sy_updatefrequency) if 'sy_updatefrequency' in d.channel else reader.settings.FEED_UPDATE_FREQUENCY
